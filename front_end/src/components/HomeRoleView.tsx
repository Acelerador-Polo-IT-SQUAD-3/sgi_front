import { IonContent, IonImg, IonHeader } from '@ionic/react'
    ...
    return (
        <>

            {
                role === 1 && (
                    <IonContent>
                        <IonHeader className="flex justify-between items-center h-78 pr-2 bg-[#326789]"></IonHeader>
                        <div className='h-[80%] flex justify-center items-center relative'>
                            <div className='relative'>
                                <img src={homeAdmin} alt='' className='h-[368px] w-[1205px] rounded-[80px]' />
                                <div className='absolute inset-0 bg-red-500 opacity-40 rounded-[80px]'></div>
                            </div>
                        ...
                        <div className=' flex justify-center gap-20 mt-10 mb-20'>
                            <div className='bg-white w-[285px] h-[334px] flex flex-col justify-center items-center gap-6 rounded-md shadow-2xl'>
                                <svg xmlns="http://www.w3.org/2000/svg" className='h-[160px]' viewBox="0 0 640 512"><path fill="#ec6565" d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304l91.4 0C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7L29.7 512C13.3 512 0 498.7 0 482.3zM609.3 512l-137.8 0c5.4-9.4 8.6-20.3 8.6-32l0-8c0-60.7-27.1-115.2-69.8-151.8c2.4-.1 4.7-.2 7.1-.2l61.4 0C567.8 320 640 392.2 640 481.3c0 17-13.8 30.7-30.7 30.7zM432 256c-31 0-59-12.6-79.3-32.9C372.4 196.5 384 163.6 384 128c0-26.8-6.6-52.1-18.3-74.3C384.3 40.1 407.2 32 432 32c61.9 0 112 50.1 112 112s-50.1 112-112 112z" /></svg>
                                <p className='text-lg  font-semibold'>Control de inscripciones</p>
                            </div>
                            <div className='bg-white w-[285px] h-[334px] flex flex-col justify-center items-center gap-6 rounded-md shadow-2xl'>
                                <svg xmlns="http://www.w3.org/2000/svg" className='h-[160px]' viewBox="0 0 576 512"><path fill="#ec6565" d="M64 0C28.7 0 0 28.7 0 64L0 352c0 35.3 28.7 64 64 64l176 0-10.7 32L160 448c-17.7 0-32 14.3-32 32s14.3 32 32 32l256 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-69.3 0L336 416l176 0c35.3 0 64-28.7 64-64l0-288c0-35.3-28.7-64-64-64L64 0zM512 64l0 224L64 288 64 64l448 0z" /></svg>
                                <p className='text-lg font-semibold'>Material didáctico</p>
                            </div>
                            <div className='bg-white w-[285px] h-[334px] flex flex-col justify-center items-center gap-6 rounded-md shadow-2xl'>
                                <svg xmlns="http://www.w3.org/2000/svg" className='h-[160px]' viewBox="0 0 512 512"><path fill="#ec6565" d="M64 0C28.7 0 0 28.7 0 64L0 352c0 35.3 28.7 64 64 64l96 0 0 80c0 6.1 3.4 11.6 8.8 14.3s11.9 2.1 16.8-1.5L309.3 416 448 416c35.3 0 64-28.7 64-64l0-288c0-35.3-28.7-64-64-64L64 0z" /></svg>
            ...
            }
            {
                role === 2 && (
                    <IonContent>
                        ...
                        <div className='h-[80%] flex justify-center items-center relative'>
                            <div className='relative'>
                                <img src={homeMentor} alt='' className='h-[368px] w-[1205px] rounded-[80px]' />
                                <div className='absolute inset-0 bg-black opacity-20 rounded-[80px]'></div>
                            </div>
                            <p className='absolute text-7xl font-bold text-white'>¡Te damos la bienvenida!</p>
                        </div>
